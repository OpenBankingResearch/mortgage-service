...
const AuthenticatedUser = require('../fixtures/mortgage-account-balance');
...
const UserPlugin = require('../../../server/api/motgage');
...
lab.before((done) => {
    ...
    const proxy = {};
    proxy[Path.join(process.cwd(), './server/models/mortgage')] = stub.Mortgage;
    ...
    const plugins = [ModelsPlugin, MortgagePlugin];
...
lab.experiment('Mortgage Plugin Result List', () => {

    lab.beforeEach((done) => {

        request = {
            method: 'GET',
            url: '/mortgage/{customerCode}'
        };
